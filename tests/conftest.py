...
def margin_cfg() -> dict:
    return {
        ...
        "tol_z": 1e-3,
        "max_iter_bisect": 12,
        "max_evals_per_axis": 15,
        "tol_phi": 1e-4,
        "n_scan_coarse": 5,
        "n_scan_fine": 9,
        "max_evals": 300,
        "directions": {"n_angles_2d": 12, "n_fib_3d": 128, "n_halton_max": 256, "halton_seed": 12345,
                        "radial_step": 0.25, "max_iter_bisect_stage_b": 6},
        "stage_c": {"maxiter": 8, "fd_step": 1e-3},
    }
