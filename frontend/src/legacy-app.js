      ...
      <section class="workspace">
        <div class="panel scenario-panel">
          ...
          <div class="action-row">
            <button class="primary" id="simulate" ${state.busy?"disabled":""}><span>${state.busy?"Running…":"Run simulation"}</span><b>↗</b></button>
            <button class="secondary" id="margin" ${state.busy?"disabled":""}>${state.busy?"Working…":"Calculate margin"}</button>
            <button class="secondary" id="rescue" ${state.busy||!state.simulate?"disabled":""}>${state.busy?"Working…":"Run rescue"}</button>
          </div>
